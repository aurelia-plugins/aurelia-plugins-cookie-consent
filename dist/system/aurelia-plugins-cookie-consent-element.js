System.register(['aurelia-plugins-cookies', 'aurelia-dependency-injection', 'aurelia-templating', './aurelia-plugins-cookie-consent-config'], function (_export, _context) {
  ...
  var Cookies, inject, bindable, customElement, Config;
  return {
    ...
    execute: function () {
      ...
      let CookieConsent = (_dec = customElement('aup-cookie-consent'), _dec2 = inject(Element, Config), _dec(_class = _dec2(_class = (_class2 = class CookieConsent {
      ...
      _export('CookieConsent', CookieConsent);
    }
  };
});